...
Try {
	...
	[string]$appName = 'M365 Apps'
	[string]$appVersion = ''
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '23/06/2022'
	...
	[string]$deployAppScriptDate = '23/06/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		## Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure `"$dirFiles\Install-MS-Apps-365.xml`""
		Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure Install-MS-Apps-365.xml"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure \remove-office.xml"			
