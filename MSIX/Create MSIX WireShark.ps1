...
$URL = "https://1.na.dl.wireshark.org/win64/Wireshark-win64-3.2.7.exe"
$InstallerType = "exe"
$Source = "$PackageName" + "." + "$InstallerType"
$UnattendedArgs = '/S /quicklaunchicon=no'
$Source = "$PackageName" + "." + "$InstallerType"
...
$xml = Get-Content $Template
$xml.replace("setArguments","/S /quicklaunchicon=no") | Out-File $Template
