<# 
.SYNOPSIS
   Clean up the browser cache on Firefox, Edge, Chrome, Waterfox & Teams.

.DESCRIPTION
   A script to clear the browser cache on Firefox, Edge, Chrome, Waterfox & Teams.

.EXAMPLE
   PS C:\> .\Browser-Cache-Cleanup.ps1
   Save the file to your hard drive with a .PS1 extention and run the file from an elavated PowerShell prompt.

.NOTES
    Also cleans up Global Windows Cache, User Cache Files & Windows User Cache Files.
