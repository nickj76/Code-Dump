...
param(
    ...
    ## Cleans up Brave Browser cache
    if (Test-Path "C:\Users\*\AppData\Local\BraveSoftware\Brave-Browser\User Data\Default\Cache\") {
        Remove-Item -Path "C:\Users\*\AppData\Local\BraveSoftware\Brave-Browser\User Data\Default\Cache\*" -Force -Recurse -Verbose -ErrorAction SilentlyContinue
    } else {
            Write-Host "C:\Users\*\AppData\Local\BraveSoftware\Brave-Browser\User Data\Default\Cache\ does not exist.                       " -NoNewline -ForegroundColor DarkGray
            Write-Host "[WARNING]" -ForegroundColor DarkYellow -BackgroundColor Black
    }
