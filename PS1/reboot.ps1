...
$EventTitle = "Please Reboot Required Now"
$EventText = "Your device needs to restart to complete upgrading to the latest version of Microsoft 365 Apps, please click on the Restart Now button below."
$ButtonTitle = "Restart Now"
$ButtonAction = "ToastReboot:"
