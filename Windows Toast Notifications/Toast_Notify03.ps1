...
If ($XMLValid -eq $True) {
    ...
    #Images
    [uri]$ImageRepositoryUri = "https://github.com/nickj76/Scripts/tree/master/Windows%20Toast%20Notifications"
    $BadgeImage = "badgeimage.jpg"
...
"@
	...
	#Create Detection Method, the detection file needs to be modified to cover subject area
	$path = "C:\logfiles"
	If(!(test-path $path))
	{
