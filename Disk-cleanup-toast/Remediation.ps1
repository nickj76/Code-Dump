...
$ToastTitle = "Low Disk Space Detected."
$Signature = "Sent by the IT Service Desk: $AlertTime"
$EventTitle = "Less than 10% of disk space left on your device"
$EventText = "Your computer is running low on disk space, this is a potential security concern as we are unable to apply further updates to your computer. Please free up space or reach out to the Service Desk if you require any assistance."
$ButtonTitle = "Clean Up Now"
$ButtonAction = "ms-settings:storagesense"
$ButtonTitle2 = "Contact IT Service Desk"
$ButtonAction2 = "https://it.surrey.ac.uk/contact-us"
...
<toast>
    <actions>
		...
		<action arguments="$ButtonAction2" content="$ButtonTitle2" activationType="protocol" />
