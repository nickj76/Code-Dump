...
.DESCRIPTION
    ...
    - Added the ability to extract .intunewin packages (select .intunewin, choose destination, click Extract) - WIP
    ...
    <Border Grid.Column="0" Background="{StaticResource CardBg}" BorderBrush="{StaticResource Line}" BorderThickness="0,0,1,0">
      <DockPanel LastChildFill="True">
        ...
        <Border DockPanel.Dock="Bottom" BorderBrush="{StaticResource Line}" BorderThickness="0,1,0,0" Padding="14" Background="{StaticResource CardBg}">
          <StackPanel>
            <TextBlock Text="IntuneWin Utility" FontSize="13" FontWeight="Bold" Foreground="#1F2D3A"/>
            <TextBlock Text="Version 3.1" FontSize="11" Foreground="#5F6B7A" Margin="0,4,0,0"/>
