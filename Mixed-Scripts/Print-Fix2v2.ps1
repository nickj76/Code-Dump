...
new-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\PointAndPrint' -Name Restricted -Value 1 -force
...
new-itemproperty -path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\PointAndPrint' -Name Serverlist -type string -value Winprint.surrey.ac.uk;winprint;surreyprint.surrey.ac.uk;surreyprint -force
...
new-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers\ListofServers' -Name Winprint.surrey.ac.uk -Value Winprint.surrey.ac.uk;winprint;surreyprint.surrey.ac.uk;surreyprint -force 
