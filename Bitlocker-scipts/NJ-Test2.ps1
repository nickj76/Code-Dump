...
Write-Output "(2). Add bitlocker key protector on remote host"
Write-Output "(3). Enable bitlocker on remote host"
Write-Output "(4). Disable bitlocker on remote host"
Write-Output "(5). Enable bitlocker on local host"
Write-Output ""
