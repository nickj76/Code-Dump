...
Try {
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        ## Copy custom UoS OSDCloudIPU Powershell Module to required location
        
        Copy-File -Path “$dirFiles\OSDCloudIPU.ps1” -Destination “C:\Temp” -Recurse
        Copy-File -Path “$dirFiles\ServiceUI.exe” -Destination “C:\Temp” -Recurse
        ...
        $STExecutable = "C:\Temp\ServiceUI.exe -Process:explorer.exe C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe"
        $STArguments = "-ExecutionPolicy Bypass -File C:\Temp\OSDCloudIPU.ps1"
