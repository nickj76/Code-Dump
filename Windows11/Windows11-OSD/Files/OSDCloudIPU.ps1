    ...
    Start-Transcript -Path C:\Windows\Logs\Software\Windows_11_IPU.log -Append
    ...
    New-Item -ItemType "file" -Path "c:\logfiles\Win11IPU-Downloaded-Install-Launched.txt"
