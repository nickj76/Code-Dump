...
$Action= New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument -ExecutionPolicy Bypass -File "C:\PS\Windows-Install-Firefox-latest.ps1" # Specify what program/script to run and with its parameters
