...
if ($Force)
{
    ...
    Get-ChildItem “HKCR:\Installer\Products” | Where-Object { $_.GetValue('ProductName') -like '*Java * Update *'} | ForEach-Object {$KeysToRemove += $_.PSPath}
    Get-ChildItem “HKCR:\Installer\Features” | Where-Object { $_.Property.Contains("jrecore") } | ForEach-Object {$KeysToRemove += $_.PSPath}
