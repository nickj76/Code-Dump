<#
.SYNOPSIS
    Install Google Chrome Proactive Remediation Script.

.DESCRIPTION
    Script to detect if Google Chrome installed on the computer.
    
.NOTES
    Filename: install-Chrome-detection.ps1
    Version: 1.1
...
$OSArchitecture = (Get-CimInstance CIM_OperatingSystem).OSArchitecture
