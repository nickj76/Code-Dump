...
<# 
.SYNOPSIS
   Attempt to gracefuly stop running Office Applications.

.DESCRIPTION
   Attempt to gracefully stop running Office Applications and prompt user to save any open work.
...
New-Item -ItemType "file" -Path "c:\logfiles\StopOfficeApps.txt"
...
.DESCRIPTION
   Install Microsoft 365 App for Enterprise Monthly Enterprise Channel.
#>
...
New-Item -ItemType "file" -Path "c:\logfiles\365AppsUpgrade-Reboot-Alert.txt"