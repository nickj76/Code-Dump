...
$ToastTitle = "Required upgrade to Microsoft 365."
$Signature = "Sent by the IT Service Desk: $AlertTime"
$EventTitle = "Your device is about to upgrade your Microsoft 365 Apps"
$EventText = "Your device is about to be upgraded with the latest version of Microsoft 365 Apps. This upgrade will take about 20 minutes to complete depending on your internet connection and cannot be paused or stopped. Please save and close any open office applications as the upgrade will begin in the next 5 minutes."
$EventText2 = "If there is an urgent need for Office whilst being upgraded, please click on the Surrey 365 button below to access Office through the web."
$ButtonTitle = "Surrey 365"
$ButtonAction = "https://365.surrey.ac.uk"
...
New-Item -ItemType "file" -Path "c:\logfiles\365Apps-Upgrade-Required.txt"

## Pause for 5 Minutes to allow users to save and close office apps.
