<#
.SYNOPSIS
   Install Script for Microsoft 365 Apps x86.

.DESCRIPTION
   Script that installs Microsoft 365 Apps x86, note this will upgrade any existing click-to-run version of office..
...
param (
    ...
    [String]
    $HeaderText = 'Important Information: Microsoft 365 Apps.',
    [Parameter(Mandatory = $false)]
    [String]
    $TitleText = 'Your Microsoft 365 Apps upgrade is almost complete.',
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText1 = 'To complete the upgrade please restart your computer now.',
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText2,
...
# xml config file
$XMLConfigurationFile = ''
$DECODED = [System.Text.Encoding]::Unicode.GetString([System.Convert]::FromBase64String($XMLConfigurationFile)) 
Write-Output $DECODED | Out-File "C:\temp\Install365-x86.xml" -NoClobber
...
$ConfigurationXMLFile = "C:\Temp\Install365-x86.xml"
...
New-Item -ItemType "file" -Path "c:\logfiles\365AppsUpgrade-Complete-x86.txt"