...
$ToastTitle = "Important Information: Microsoft 365 upgrade."
$Signature = "Sent by the IT Service Desk: $AlertTime"
$EventTitle = "Your device is about to upgrade your Microsoft 365 Apps"
$EventText = "Your device is about to be upgraded with the latest version of Microsoft 365 Apps. This upgrade will take about 15 minutes to complete depending on your internet connection and cannot be paused or stopped. Please save and close any open Office applications as the upgrade will begin in the next 5 minutes."
...
New-Item -ItemType "file" -Path "c:\logfiles\Office-Upgrade-Toast.txt"
