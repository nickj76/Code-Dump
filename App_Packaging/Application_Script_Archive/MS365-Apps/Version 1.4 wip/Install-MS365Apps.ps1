...
.DESCRIPTION
   Script that installs Microsoft 365 Apps using parameters that you specify in the xml file e.g. Install-MS-Apps-365.xml & along with a Toast at the completion of the install to reboot.
...
Write-Output $DECODED | Out-File "C:\temp\Install365.xml" -NoClobber
...
$ConfigurationXMLFile = "C:\Temp\Install365.xml"
...
New-Item -ItemType "file" -Path "c:\logfiles\365AppsUpgrade-Complete.txt"