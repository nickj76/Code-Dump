...
.DESCRIPTION
   ...
   Check line 140 e.g. $ConfigurationXMLFile = "C:\Temp\Install-MS-Apps-365.xml"

.EXAMPLE
   PS C:\> .\Install-Office365.ps1
...
$ConfigurationXMLFile = "C:\Temp\Install-MS-Apps-365.xml"
...
New-Item -ItemType "file" -Path "c:\logfiles\InstallMS365Apps.txt"