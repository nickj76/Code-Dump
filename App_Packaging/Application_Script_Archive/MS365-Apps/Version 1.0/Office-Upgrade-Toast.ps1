...
$ToastTitle = "Important Information: Please review the details below."
$Signature = "Sent on behalf of the IT Service Desk."
$EventTitle = "Upgrade to Microsoft 365 Apps"
$EventText = "Your device is about to be upgraded with the latest version of Microsoft 365 Apps. This upgrade will take about 15 minutes to complete depending on your internet connection and cannot be paused or stopped, so please save and close any open office applications as the upgrade will begin in the next 5 minutes."
