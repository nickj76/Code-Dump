<# 
.SYNOPSIS
   Script to remove Office 365 C2R.

.DESCRIPTION
      Script that removes Office365 using parameters that you specify in the xml file e.g. Remove-Office.xml.
      Check line 140 e.g. $ConfigurationXMLFile = "C:\Temp\Remove-Office.xml"

.EXAMPLE
   PS C:\> .\Remove-Office.ps1
   PS C:\> .\Remove-Office.ps1 -ConfigurationXMLFile "C:\Scripts\OfficeConfig.xml"
...
$ConfigurationXMLFile = "C:\Temp\Remove-Office.xml"
...
New-Item -ItemType "file" -Path "c:\logfiles\RemoveOfficeC2R.txt"