...
param (
    ...
    [String]
    $HeaderText = 'Important Information: Please review the below;',
    [Parameter(Mandatory = $false)]
    [String]
    $TitleText = 'Upgrade to Microsoft 365 Apps',
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText1 = 'The upgrade to Microsoft 365 Apps is almost finished to complete the upgrade please restart your computer now.',
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText2,
